...
# Project GID — find via: GET https://app.asana.com/api/1.0/projects
PROJECT_GID = "YOUR_PROJECT_GID"

# Section GID within the project (optional — set to None to skip)
# Find via: GET https://app.asana.com/api/1.0/projects/{project_gid}/sections
SECTION_GID = None  # e.g. "1234567890"
...
def create_task_from_scratch() -> str:
    ...
    print("Creating new task from scratch...")
    payload = {
        "data": {
            "name": TASK_NAME,
            "assignee": ASSIGNEE,
